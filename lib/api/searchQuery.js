...
/**
 * Api Endpoint. 
 * This connector provides only one API endpoint and this is the query endpoint. 
 * This api uses the "customsearch" model, to generate its collection. Extra fields are added to the repsonse structure. And these are -
 *  
 */
var searchQuery = server.addAPI(Arrow.API.extend({
    group: 'Google Search',
    path: apiPath,
    method: 'GET',
    nickname: 'Query',
